...
public class AList0_F extends AList0 implements EList
{
	...
	public int Max(int[]ar, int i)
	{
		if(ar.length == i)
			return Integer.MIN_VALUE;
		
		return Math.max(ar[i], Max(ar, i+1));
	}
	...
	public String numToStr(int ar[], int i)
	{
		if(ar.length == i)
			return "";
		
		String ret = "";
		ret = ar[i] + " " + numToStr(ar, i+1);
